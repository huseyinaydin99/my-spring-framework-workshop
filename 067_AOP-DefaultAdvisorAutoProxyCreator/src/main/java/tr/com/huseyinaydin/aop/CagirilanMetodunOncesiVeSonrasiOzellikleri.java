...
public class CagirilanMetodunOncesiVeSonrasiOzellikleri implements MethodInterceptor {
	...
	public Object invoke(MethodInvocation methodInvocation) throws Throwable {
		...
		System.out.println("****Çağırılan metodun argumentleri : " + Arrays.toString(methodInvocation.getArguments()));
		try {
			...
			System.out.println("****Çağırılan metotta İSTİSNA " + "meydana gelme dururmu.");
			throw e;
		}
	}
}